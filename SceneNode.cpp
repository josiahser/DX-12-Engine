...
{
	//Parents own their children, if this node isn't owned by anyone else
	//it will cease to exist if we remove it from it's parent
	//As a preacaution store myself as a shared pointer so I don't get deleted halfway through this function
	//Technically, self deletion shouldn't occur because the thing invoking this function should have a shared_ptr to it
